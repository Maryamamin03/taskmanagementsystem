...
import 'package:taskms/password.dart';
...
class _PrivacySecurityState extends State<PrivacySecurity> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
     ...
     body: SafeArea(child: Scaffold(body: Padding(padding: EdgeInsets.only(left:he*0.03,right:he*0.03),
     child:Column(
       crossAxisAlignment: CrossAxisAlignment.start,
       children: [
         upperHeader('Privacy & Security', context, false, page: SettingsPage() ),
         ...
         CustomOption('MyAccount', Icons.account_circle, (){},),
